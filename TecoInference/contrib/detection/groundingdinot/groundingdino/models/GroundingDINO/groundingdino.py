...
class GroundingDINO(nn.Module):
    ...
    def forward(self, samples: NestedTensor, input_ids, token_type_ids, attention_mask, targets: List = None, **kw):
        ...
        (
            ...
            input_ids, self.specical_tokens, self.tokenizer
        )
        ...
        if self.sub_sentence_present:
            ...
            encoder_attention_mask = text_self_attention_masks
        ...
        bert_output = self.bert(input_ids=encoder_input_ids, attention_mask=encoder_attention_mask,
                                token_type_ids=encoder_token_type_ids, position_ids=encoder_position_ids)
        ...
        out = torch.cat((outputs_class[-1], outputs_coord_list[-1]), dim=-1)
