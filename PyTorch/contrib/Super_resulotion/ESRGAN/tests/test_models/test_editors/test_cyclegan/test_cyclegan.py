...
def test_cyclegan():
    ...
    if torch.sdaa.is_available():
        ...
        data_batch_cuda['img_mask'] = inputs.sdaa()
        data_batch_cuda['img_photo'] = targets.sdaa()
        ...
        # train_step
        inputs = torch.rand(1, 3, 64, 64).sdaa()
        targets = torch.rand(1, 3, 64, 64).sdaa()
