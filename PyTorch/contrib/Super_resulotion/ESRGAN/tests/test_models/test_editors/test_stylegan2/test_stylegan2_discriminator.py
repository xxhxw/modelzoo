...
class TestStyleGANv2Disc:
    ...
    def test_stylegan2_disc_cuda(self):
        d = StyleGAN2Discriminator(**self.default_cfg).sdaa()
        ...
        d = StyleGAN2Discriminator(**cfg).sdaa()
        score = d(img, torch.randn(2, 5).sdaa())
        assert score.shape == (2, 1)
