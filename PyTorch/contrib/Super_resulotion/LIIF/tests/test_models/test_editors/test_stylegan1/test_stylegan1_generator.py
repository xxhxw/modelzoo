...
class TestStyleGAN1Generator:
    ...
    def test_g_cuda(self):
        # test default config
        g = StyleGAN1Generator(**self.default_cfg).sdaa()
        ...
        styles = [torch.randn((1, 512)).sdaa() for _ in range(2)]
        res = g(
