...
def init_dist(backend='tccl', **kwargs):
    ...
    # device = torch.device(f"sdaa:{rank % num_gpus}")
    # torch.sdaa.set_device(device)
    # print("AAAAA",rank % num_gpus)
...
def main():
    ...
    if opt['path'].get('resume_state', None):
        ...
        resume_state = torch.load(opt['path']['resume_state'],
                                  map_location=lambda storage, loc: storage.sdaa(device_id))
