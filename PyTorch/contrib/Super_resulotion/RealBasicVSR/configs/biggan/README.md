...
`BigGAN 128x128` model is trained with V100 GPUs and sdaa 10.1 and can hardly reproduce the result with A100 and sdaa 11.3. If you have any idea about the reproducibility, please feel free to contact with us.
