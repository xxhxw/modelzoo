...
دعونا نستدعي [`torch.sdaa.max_memory_allocated`](https://pytorch.org/docs/stable/generated/torch.sdaa.max_memory_allocated.html) لقياس ذروة تخصيص ذاكرة وحدة معالجة الرسومات (GPU).
