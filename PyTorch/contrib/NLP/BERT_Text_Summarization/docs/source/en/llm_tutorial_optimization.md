...
Let's call [`torch.sdaa.max_memory_allocated`](https://pytorch.org/docs/stable/generated/torch.sdaa.max_memory_allocated.html) to measure the peak GPU memory allocation.

```python
bytes_to_giga_bytes(torch.sdaa.max_memory_allocated())
```
