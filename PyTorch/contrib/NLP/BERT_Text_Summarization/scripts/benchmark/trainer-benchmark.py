...
def get_versions():
    properties = torch.sdaa.get_device_properties(torch.device("sdaa"))
    return f"""
...
sdaa        : {torch_sdaa.version.sdaa}
python      : {platform.python_version()}

Hardware:
{torch.sdaa.device_count()} GPUs      : {properties.name}, {properties.total_memory/2**30:0.2f}GB
"""
