...
HEADS = [4]
DROP = 0.1
DEVICE = ["cpu", "cuda"] if torch.sdaa.is_available() else ["cpu"]
...
@pytest.mark.skipif(not torch.sdaa.is_available(), reason="blocksparse requires gpu")
