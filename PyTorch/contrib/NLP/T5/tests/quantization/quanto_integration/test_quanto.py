...
class QuantoQuantizationTest(unittest.TestCase):
    ...
    def test_generate_quality_cuda(self):
        ...
        """
        self.check_inference_correctness(self.quantized_model, "sdaa")
    ...
    def test_quantized_model_layers(self):
        ...
        if self.device_map in ["cpu", "sdaa"]:
            self.assertEqual(
        ...
        self.assertEqual(
            self.quantized_model.transformer.h[0].self_attention.query_key_value.weight._data.device.type, "sdaa"
        )
    ...
    def test_serialization_bin(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdirname:
            ...
            # )
            # self.check_inference_correctness(quantized_model_from_saved, device="sdaa")
    ...
    def test_compare_with_quanto(self):
        ...
        self.check_inference_correctness(model, device="sdaa")
