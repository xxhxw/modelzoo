...
DEFAULT_DEVICE = "sdaa" if torch.sdaa.is_available() else "cpu"
...
def run_generate(verbose=True):
    ...
    parser.add_argument("--device", type=str, required=False, default=DEFAULT_DEVICE, help="sdaa, cuda:1, cpu etc.")
    parser.add_argument(
