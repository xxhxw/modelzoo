...
class GPT2SdpaAttention(GPT2Attention):
    ...
    def forward(
        ...
        if self.require_contiguous_qkv and query.device.type == "sdaa" and attention_mask is not None:
...
class GPT2Model(GPT2PreTrainedModel):
    ...
    def parallelize(self, device_map=None):
        ...
        self.device_map = (
            get_device_map(len(self.h), range(torch.sdaa.device_count())) if device_map is None else device_map
        )
...
class GPT2LMHeadModel(GPT2PreTrainedModel, GenerationMixin):
    ...
    def parallelize(self, device_map=None):
        ...
        self.device_map = (
            get_device_map(len(self.transformer.h), range(torch.sdaa.device_count()))
    ...
    def forward(
        ...
        if self.model_parallel:
            torch.sdaa.set_device(self.transformer.first_device)
