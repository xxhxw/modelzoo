...
from squeezenext import SqNxt_23_1x
...
def main(args):
    ...
    model = SqNxt_23_1x(num_classes=1000)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', type=str, default='/data/ckpt/SqueezeNext/experiments/')

    opt = parser.parse_args()
    
    opt.str_lr = str(opt.lr).replace('.', '_')
    if not opt.distributed:
        opt.path = '/data/ckpt/SqueezeNext/single_experiments/'
