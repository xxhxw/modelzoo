...
def main():
    ...
    if utils.is_primary(args):
        ...
        _dllogger = Logger(
            [
                JSONStreamBackend(Verbosity.VERBOSE, os.path.join(output_dir, 'log.json')),
            ]
        )
        _dllogger.metadata("train.loss", {"unit": "", "GOAL": "MINIMIZE", "STAGE": "TRAIN"})
        _dllogger.metadata("train.loss_mean", {"unit": "", "GOAL": "MINIMIZE", "STAGE": "TRAIN"})
        _dllogger.metadata("train.time", {"unit": "s", "GOAL": "MINIMIZE", "STAGE": "TRAIN"})
        _dllogger.metadata("train.time_mean", {"unit": "s", "GOAL": "MINIMIZE", "STAGE": "TRAIN"})
        _dllogger.metadata("train.ips",{"unit": "imgs/s", "format": ":.3f", "GOAL": "MAXIMIZE", "STAGE": "TRAIN"})
        _dllogger.metadata("train.ips_mean",{"unit": "imgs/s", "format": ":.3f", "GOAL": "MAXIMIZE", "STAGE": "TRAIN"})
        _dllogger.metadata("train.lr",{"unit": "imgs/s", "format": ":.3f", "GOAL": "MAXIMIZE", "STAGE": "TRAIN"})
        _dllogger.metadata("train.data_time",{"unit": "imgs/s", "format": ":.3f", "GOAL": "MAXIMIZE", "STAGE": "TRAIN"})
        _dllogger.metadata("train.data_time_mean",{"unit": "imgs/s", "format": ":.3f", "GOAL": "MAXIMIZE", "STAGE": "TRAIN"})
        _dllogger.metadata("test.time", {"unit": "", "GOAL": "MINIMIZE", "STAGE": "VALID"})
        _dllogger.metadata("test.time_mean", {"unit": "", "GOAL": "MINIMIZE", "STAGE": "VALID"})
        _dllogger.metadata("test.loss", {"unit": "", "GOAL": "MINIMIZE", "STAGE": "VALID"})
        _dllogger.metadata("test.loss_mean", {"unit": "", "GOAL": "MINIMIZE", "STAGE": "VALID"})
        _dllogger.metadata("test.acc1", {"unit": "%", "format": ":.2f", "GOAL": "MAXIMIZE", "STAGE": "VALID"})
        _dllogger.metadata("test.acc1_mean", {"unit": "%", "format": ":.2f", "GOAL": "MAXIMIZE", "STAGE": "VALID"})
        _dllogger.metadata("test.acc5", {"unit": "%", "format": ":.2f", "GOAL": "MAXIMIZE", "STAGE": "VALID"})
        _dllogger.metadata("test.acc5_mean", {"unit": "%", "format": ":.2f", "GOAL": "MAXIMIZE", "STAGE": "VALID"})
            ...
            if utils.is_primary(args):
                ...
                _dllogger.log(
                    ...
                    data = {
                            ...
                            "train_loss_mean":losses_m.avg,
                            "train_time":update_time_m.val,
                            "train_time_mean":update_time_m.avg,
                            "train_ips":update_sample_count / update_time_m.val,
                            "train_ips_mean":update_sample_count / update_time_m.avg,
                            "train_lr":lr,
                            "train_data_time":data_time_m.val,
                            "train_data_time_mean":data_time_m.avg,
                            },
            ...
            if utils.is_primary(args) and (last_batch or batch_idx % args.log_interval == 0):
                ...
                _dllogger.log(
                    ...
                    data = {
                            ...
                            "val_loss_mean":losses_m.avg,
                            "val_time":batch_time_m.val,
                            "val_time_mean":batch_time_m.avg,
                            "val_acc1":top1_m.val,
                            "val_acc1_mean":top1_m.avg,
                            "val_acc5":top5_m.val,
                            "val_acc5_mean":top5_m.avg,
                            },
                    verbosity=Verbosity.DEFAULT
                )
