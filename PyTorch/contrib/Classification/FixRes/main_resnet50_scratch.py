...
if __name__ == "__main__":
    ...
    parser.add_argument('--imnet-path', default='/data/dataset/imagenet', type=str, help='ImageNet dataset path')
    parser.add_argument('--shared-folder-path', default='/data/application/zhaohr/shipei/FixRes/outoutdir', type=str, help='Shared Folder')
