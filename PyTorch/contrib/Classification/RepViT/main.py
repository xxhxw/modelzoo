...
def get_args_parser():
    ...
    parser.add_argument('--data-path', default='/data/datasets/imagenet', type=str,
                        help='dataset path')
    ...
    parser.add_argument('--output_dir', default='/data/ckpt/',
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if utils.is_main_process():
            print({**{f'train_{k}': v for k, v in train_stats.items()},
                    **{f'test_{k}': v for k, v in test_stats.items()},
                    'epoch': epoch,
