...
def main_worker(gpu, ngpus_per_node, args, cfg):
    ...
    if args.gpu == 0:
        mkdir(args.outdir)
        filename = os.path.join(args.outdir, 'train_sdaa_3rd_resnest50.txt')#'train_sdaa_3rd'
    ...
    def train(epoch):
        ...
        for batch_idx, (data, target) in enumerate(train_loader):
            ...
            if batch_idx % 100 == 0 and args.gpu == 0:
                ...
                plt.savefig('./scripts/train_sdaa_3rd_resnest50.png')
    ...
    def validate(epoch):
        ...
        if args.gpu == 0:
            ...
            save_checkpoint({
                ...
                is_best=False,
                filename=f'resnest50_checkpoint_{epoch}.pth')
