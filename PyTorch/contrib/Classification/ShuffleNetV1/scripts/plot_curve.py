...
# 日志文件路径
file_path = '/data/modelzoo/PyTorch/contrib/Classification/ShuffleNetV1/experiments/train_sdaa_3rd.log/train_sdaa_3rd.log'
...
# 保存损失图像
plt.tight_layout()
plt.savefig('/data/modelzoo/PyTorch/contrib/Classification/ShuffleNetV1/experiments/train_sdaa_3rd_ori.png')
plt.show()
...
if val_accs:
    ...
    # 保存准确率图像
    plt.tight_layout()
    plt.savefig('/data/modelzoo/PyTorch/contrib/Classification/ShuffleNetV1/scripts/train_sdaa_3rd.png')
    plt.show()
