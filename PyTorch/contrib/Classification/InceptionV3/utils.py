...
def get_training_dataloader(mean, std , dataset_path, sampler=None, batch_size=16, num_workers=2, shuffle=True):
    ...
    cifar10_training_loader = DataLoader(
        cifar10_training, shuffle=shuffle, num_workers=num_workers, batch_size=batch_size, sampler=sampler)

    return cifar10_training_loader

def get_test_dataloader(mean, std , dataset_path, sampler=None, batch_size=16, num_workers=2, shuffle=True):
    """ return training dataloader
    Args:
    ...
    cifar10_test_loader = DataLoader(
        cifar10_test, shuffle=shuffle, num_workers=num_workers, batch_size=batch_size, sampler=sampler)
