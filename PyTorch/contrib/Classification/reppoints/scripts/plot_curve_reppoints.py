...
directory = '../work_dirs/reppoints-bbox_r50_fpn-gn_head-gn-grid_1x_coco'
latest_folder = get_latest_folder(directory)

print(f"The latest folder is: {latest_folder}")
latest_file = '../work_dirs/reppoints-bbox_r50_fpn-gn_head-gn-grid_1x_coco/' + latest_folder + '/vis_data/scalars.json'
