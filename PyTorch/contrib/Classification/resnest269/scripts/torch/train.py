...
def main_worker(gpu, ngpus_per_node, args, cfg):
    ...
    if args.gpu == 0:
        mkdir(args.outdir)
        filename = os.path.join(args.outdir, 'train_sdaa_3rd_resnest269.txt')
    ...
    def train(epoch):
        ...
        for batch_idx, (data, target) in enumerate(train_loader):
            ...
            if batch_idx % 100 == 0 and args.gpu == 0:
                ...
                plt.savefig('./scripts/train_sdaa_3rd_resnest269.png')
    ...
    def validate(epoch):
        ...
        if args.gpu == 0:
            ...
            save_checkpoint({
                ...
                is_best=False,
                filename=f'resnest269_checkpoint_{epoch}.pth')
