...
# SDAA loss values count: 10
# CUDA loss values count: 10
# Mean Relative Error (MRE): -0.014209
# Mean Absolute Error (MAE): 0.150280

# Test Result:
# PASS - MRE (-0.014209) <= 0.05 or MAE (0.150280) <= 0.0002
