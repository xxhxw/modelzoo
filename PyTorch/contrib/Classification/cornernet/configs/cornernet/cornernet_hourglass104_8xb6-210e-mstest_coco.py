...
# dist.init_process_group(backend='tccl', init_method='tcp://127.0.0.1:65501',
#                                 world_size=1, rank=0)
# train_sampler = torch.utils.data.distributed.DistributedSampler(dict(pipeline=train_pipeline))
