...
def main():
    ...
    if 'ViT-B-16' in model_path:
        phi = "openai/VIT-B-16"
    elif 'ViT-B-32' in model_path:
        phi = "openai/VIT-B-32"
    ...
    datasets_train_json_path = os.path.join(datasets_path, "en_train.json")
    datasets_val_json_path = os.path.join(datasets_path, "en_val.json")
