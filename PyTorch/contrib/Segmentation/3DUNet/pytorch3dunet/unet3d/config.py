...
def load_config():
    ...
    parser.add_argument('--config', type=str, help='Path to the YAML config file', default = "/root/cas/LRB/3DUnet/resources/3DUnet_confocal_boundary/train_config.yml",required=True)
