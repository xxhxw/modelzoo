...
def get_args():
    ...
    arg('--time_out', type=int, default=7200, help='train time')
    arg('--save', type=str, default='scripts', help='save trained model here')

    # data set related:/data/datasets/cityscapes/
    # arg('--datapath',  type=str, default='/media/HDD1/Datasets', help='dataset location')
    arg('--datapath',  type=str, default='/data/datasets/cityscapes/', help='dataset location')
