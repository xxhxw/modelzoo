...
参数名 | 解释 | 样例
-----------------|-----------------|-----------------
work_dir |实验工作目录 | --work_dir experiments/pspnet50
dataset_path| 数据集根目录 | --dataset_path /mnt/nvme/common/train_dataset/voc
dataset | 数据集名称，可根据用户需求扩展 | --dataset voc
num_classes | 数据集目标类别数，voc为20 | --num_classes 20
model_name | 模型名称 | --model_name /pspnet50
...
ckpt| 断点重训加载的checkpoint文件 | --ckpt experiments/example/best_pspnet_voc.pth
