...
class DeformConv2dFunction(Function):
    ...
    def forward(ctx,
        ...
        input = input.cpu().contiguous() # jy改
...
class DeformConv2d(nn.Module):
    ...
    Note:
        ...
        number of samples processed by the ``im2col_sdaa_kernel`` per call.
    ...
    Args:
        ...
        bias (bool): If True, adds a learnable bias to the output.
            Default: False.
        im2col_step (int): Number of samples processed by im2col_sdaa_kernel
    ...
    def forward(self, x: Tensor, offset: Tensor) -> Tensor:
        ...
        """
        # To fix an assert error in deform_conv_sdaa.cpp:128
    ...
    class DeformConv2dPack_MLU(DeformConv2d):
        ...
        Args:
            ...
            im2col_step (int): Number of samples processed by
                im2col_sdaa_kernel per call. It will work when ``batch_size``
