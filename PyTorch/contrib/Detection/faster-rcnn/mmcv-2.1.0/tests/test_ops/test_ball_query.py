...
def test_stack_ball_query():
    new_xyz = torch.tensor([[-0.0740, 1.3147, -1.3625],
                            ...
                            [-2.0289, 2.4952, -0.1708],
                            [-2.0289, 2.4952, -0.1708]]).sdaa()
    new_xyz_batch_cnt = torch.tensor([5, 5], dtype=torch.int32).sdaa()
