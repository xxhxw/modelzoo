...
class ProfilerHook(Hook):
    ...
    Args:
        ...
        activity_with_sdaa (bool): Activities to be used in the analysis (SDAA)
    ...
    def __init__(self,
        ...
        assert isinstance(activity_with_sdaa, bool), \
            '``activity_with_sdaa`` should be a boolean.'
        self.activities = []
        if activity_with_cpu:
            self.activities.append(profiler.ProfilerActivity.CPU)
        if activity_with_sdaa:
            self.activities.append(profiler.ProfilerActivity.SDAA)
