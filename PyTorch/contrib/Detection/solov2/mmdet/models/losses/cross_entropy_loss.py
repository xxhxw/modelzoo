...
def _expand_onehot_labels(labels, label_weights, label_channels, ignore_index):
    ...
    # on_trace_ready=torch.profiler.tensorboard_trace_handler(dir_name='/root/profilecross2/'),
    ...
    # with torch.profiler.record_function("nonzero"):
    #     # 导致cpu和gpu同步，当 input 在 CUDA 上时， torch.nonzero() 会导致主机设备同步。
    inds = torch.nonzero(
