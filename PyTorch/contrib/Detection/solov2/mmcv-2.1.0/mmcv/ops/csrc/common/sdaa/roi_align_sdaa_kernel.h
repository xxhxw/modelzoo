...
#ifndef ROI_ALIGN_SDAA_KERNEL_CUH
#define ROI_ALIGN_SDAA_KERNEL_CUH
...
#include "parrots_sdaa_helper.hpp"
...
/*** Forward ***/
template <typename T>
__global__ void roi_align_forward_sdaa_kernel(
  ...
  SDAA_1D_KERNEL_LOOP(index, nthreads) {
...
/*** Backward ***/
template <typename T>
__global__ void roi_align_backward_sdaa_kernel(
...
#endif  // ROI_ALIGN_SDAA_KERNEL_CUH
