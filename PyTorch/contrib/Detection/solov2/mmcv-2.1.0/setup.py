...
#     #     EXT_TYPE = 'pytorch'
#     # else:
#     #     from torch_sdaa.utils.cpp_extension import BuildExtension
#     #     EXT_TYPE = 'pytorch'
...
#         define_macros = []
#         include_dirs = []
#         op_files = glob.glob('./mmcv/ops/csrc/pytorch/sdaa/*.cu') +\
#             glob.glob('./mmcv/ops/csrc/pytorch/cpu/*.cpp') +\
#             glob.glob('./mmcv/ops/csrc/parrots/*.cpp')
#         include_dirs.append(os.path.abspath('./mmcv/ops/csrc/common'))
#         include_dirs.append(os.path.abspath('./mmcv/ops/csrc/common/sdaa'))
#         op_files.remove('./mmcv/ops/csrc/pytorch/sdaa/iou3d_sdaa.cu')
#         op_files.remove('./mmcv/ops/csrc/pytorch/cpu/bbox_overlaps_cpu.cpp')
#         op_files.remove('./mmcv/ops/csrc/pytorch/sdaa/bias_act_sdaa.cu')
#         sdaa_args = os.getenv('MMCV_SDAA_ARGS')
#         extra_compile_args = {
#             'nvcc': [sdaa_args, '-std=c++14'] if sdaa_args else ['-std=c++14'],
#             'cxx': ['-std=c++14'],
#         }
#         if torch.sdaa.is_available() or os.getenv('FORCE_SDAA', '0') == '1':
#             define_macros += [('MMCV_WITH_SDAA', None)]
#             extra_compile_args['nvcc'] += [
#                 '-D__SDAA_NO_HALF_OPERATORS__',
#                 '-D__SDAA_NO_HALF_CONVERSIONS__',
#                 '-D__SDAA_NO_HALF2_OPERATORS__',
#             ]
#         ext_ops = Extension(
#             name=ext_name,
#             sources=op_files,
...
#         ext_name = 'mmcv._ext'
#         # from torch_sdaa.utils.cpp_extension import CppExtension, TecoExtension
#         # from torch_sdaa.utils.cpp_extension import TecoExtension, BuildExtension
...
#         # Before PyTorch1.8.0, when compiling SDAA code, `cxx` is a
...
#                                        (SDAA_HOME is not None)) else False
#         except ImportError:
#             pass
...
#             tccl_include_dirs = os.getenv('TCCL_INCLUDE_DIRS')
...
#             if tccl_include_dirs:
#                 include_dirs.append(tccl_include_dirs)
#             library_dirs += [dipu_root]
#             libraries += ['torch_dipu']
#         elif is_rocm_pytorch or torch.sdaa.is_available() or os.getenv(
#                 'FORCE_SDAA', '0') == '1':
#             if is_rocm_pytorch:
#                 define_macros += [('MMCV_WITH_HIP', None)]
#             define_macros += [('MMCV_WITH_SDAA', None)]
#             sdaa_args = os.getenv('MMCV_SDAA_ARGS')
#             extra_compile_args['nvcc'] = [sdaa_args] if sdaa_args else []
#             op_files = glob.glob('./mmcv/ops/csrc/pytorch/*.cpp') + \
#                 glob.glob('./mmcv/ops/csrc/pytorch/cpu/*.cpp') + \
#                 glob.glob('./mmcv/ops/csrc/pytorch/sdaa/*.cu') + \
#                 glob.glob('./mmcv/ops/csrc/pytorch/sdaa/*.cpp')
#             extension = TecoExtension
