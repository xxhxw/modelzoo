...
class Runner:
    ...
    Args:
        ...
        env_cfg (dict): A dict used for setting environment. Defaults to
            dict(dist_cfg=dict(backend='tccl')).
    ...
    def __init__(
        ...
        resume: bool = False,
        launcher: str = 'none',
        env_cfg: Dict = dict(dist_cfg=dict(backend='tccl')),
    ...
    def from_cfg(cls, cfg: ConfigType) -> 'Runner':
        ...
        runner = cls(
            ...
            env_cfg=cfg.get('env_cfg', dict(dist_cfg=dict(backend='tccl'))),
    ...
    def setup_env(self, env_cfg: Dict) -> None:
        ...
        An example of ``env_cfg``::
            ...
            env_cfg = dict(
                ...
                dist_cfg=dict(backend='tccl', timeout=1800),
                resource_limit=4096
            )
    ...
    def wrap_model(
        ...
        # Set `export SDAA_VISIBLE_DEVICES=-1` to enable CPU training.
