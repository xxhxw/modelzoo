...
class VOCDetection(CacheDataset):
    ...
    def __init__(
        ...
        for (year, name) in image_sets:
            self._year = year
            rootpath = os.path.join(self.root, "VOC" + '2012')
            for line in open(
    ...
    def _do_python_eval(self, output_dir="output", iou=0.5):
        ...
        #rootpath = "/root/YOLOX-main/datasets/VOCdevkit/VOC2012"
        rootpath = Path(__file__).resolve()
        rootpath = rootpath.parent.parent.parent.parent
        name = self.image_set[0][1]
        annopath = os.path.join(rootpath,"datasets","VOCdevkit","VOC2012", "Annotations", "{:s}.xml")
        imagesetfile = os.path.join(rootpath, "datasets","VOCdevkit","VOC2012","ImageSets", "Main", name + ".txt")
        #imagesetfile = '/root/YOLOX-main/datasets/VOCdevkit/VOC2012/ImageSets/Main/test.txt'
