...
if __name__ == '__main__':
    ...
    train_features = extract_features(model, data_loader_train, args.use_sdaa, multiscale=args.multiscale)
    query_features = extract_features(model, data_loader_query, args.use_sdaa, multiscale=args.multiscale)
