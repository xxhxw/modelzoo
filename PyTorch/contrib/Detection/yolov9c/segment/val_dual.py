...
def run(
        ...
        device='',  # sdaa device, i.e. 0 or 0,1,2,3 or cpu
    ...
    if training:  # called by train.py
        ...
        half = model.fp16  # FP16 supported on limited backends with sdaa
...
def main(opt):
    ...
    if opt.task in ('train', 'val', 'test'):  # run normally
        ...
        opt.half = torch.sdaa.is_available() and opt.device != 'cpu'  # FP16 for fastest results
