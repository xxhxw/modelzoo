...
class YOLOLoss(nn.Module):
    ...
    def box_iou(self, b1, b2):
        ...
        b2_mins = b2_mins.to('sdaa')
        b2_maxes = b2_maxes.to('sdaa')
        #----------------------------------------------------#
        #   求真实框和预测框的iou
        #----------------------------------------------------#
        ...
        b1_area = b1_area.to('sdaa')
        b2_area = b2_area.to('sdaa')
        intersect_area = intersect_area.to('sdaa')
    ...
    def forward(self, l, input, targets=None):
        ...
        pred_cls = pred_cls.to('sdaa')
        #-----------------------------------------------#
        #   获得网络应该有的预测结果
        #-----------------------------------------------#
        y_true, noobj_mask, box_loss_scale = self.get_target(l, targets, scaled_anchors, in_h, in_w)
        y_true = y_true.to('sdaa')
    ...
    def get_ignore(self, l, x, y, h, w, targets, scaled_anchors, in_h, in_w, noobj_mask):
        ...
        for b in range(bs):
            ...
            if len(targets[b]) > 0:
                #print("yes")
                batch_target = torch.zeros_like(targets[b]).to('sdaa')
                #print(b)
                #print(batch_target.device)
