...
def main():
    ...
    valann = cfg.val_evaluator.ann_file
    testann = cfg.test_evaluator.ann_file
    if args.data_dir is not None:
        # 更新通用数据根目录
        cfg.data_root = args.data_dir
        cfg.train_dataloader.dataset.data_root = args.data_dir
        cfg.val_dataloader.dataset.data_root = args.data_dir
        cfg.test_dataloader.dataset.data_root = args.data_dir
        cfg.val_evaluator.ann_file = valann.replace("data/coco", args.data_dir)
        cfg.test_evaluator.ann_file = testann.replace("data/coco", args.data_dir)
