...
def draw_curve(epoch, train_loss, train_err, test_loss, test_err):
    ...
    if epoch == 49:
        ax0.legend()
        ax1.legend()
    fig.savefig("./scripts/train_sdaa_3rd_deepsort.jpg")
...
def main(args):
    ...
    if rank == 0:
        print(args)
        if os.path.exists('/data/ckpt/deepsort') is False:
            os.mkdir('/data/ckpt/deepsort')
    ...
    for epoch in range(start_epoch, start_epoch + args.epochs):
        ...
        if rank == 0:
            ...
            torch.save(state_dict, '/data/ckpt/deepsort/model_{}.pth'.format(epoch))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--device', default='sdaa', help='device id (i.e. 0 or 0, 1 or cpu)')
