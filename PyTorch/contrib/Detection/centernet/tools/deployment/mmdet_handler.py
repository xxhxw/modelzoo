import torch_sdaa# Copyright (c) OpenMMLab. All rights reserved.
import base64
import os
...
class MMdetHandler(BaseHandler):
    ...
    def initialize(self, context):
        ...
        self.map_location = 'sdaa' if torch.sdaa.is_available() else 'cpu'
        self.device = torch.device(self.map_location + ':' +
                                   str(properties.get('gpu_id')) if torch.sdaa.
