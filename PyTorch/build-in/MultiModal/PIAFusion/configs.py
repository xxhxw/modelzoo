...
def set_args():
    ...
    parser.add_argument('--lr', '--learning-rate', type=float, default=1e-4, help='select the learning rate,'
                                                                                  'default=1e-2')
    # 打印输出
