...
def parse_args():
    ...
    parser.add_argument('-ts', '--train-size',nargs='+', help='size of train dataset',default=[200,300], type=int) 
    parser.add_argument('-vs', '--valid-size',nargs='+', help='size of valid dataset',default=[200,300], type=int)  
