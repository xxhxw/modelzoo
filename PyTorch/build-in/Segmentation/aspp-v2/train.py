...
def create_model(num_classes, pretrain=True):
    ...
    if pretrain:
        weights_dict = torch.load("./aspp_deeplab_v2_5b_tshdxgmrtpf498.pth", map_location='cpu')
...
def parse_args():
    ...
    parser.add_argument("--data-path", default="/mnt_qne00/dataset/", help="VOCdevkit root")
    parser.add_argument("--num-classes", default=20, type=int)
    parser.add_argument("--device", default="sdaa", help="training device")
